...
## [NAATOS TB V1](./TB-V1/overview.md)

The United Nations Sustainable Development Goal 3.3 targets an end to the global tuberculosis epidemic by 2030[^7].
Unfortunately, poor diagnostic access and low utilization of TB testing has allowed large-scale treatment delays and disease transmission. However, these issues can be addressed with an accurate, affordable, and accessible diagnostic tool that meets the performance criteria of high sensitivity, specificity (95% specificity), and affordability ($4.5 USD all-inclusive) set out by the WHO[^8].
...
[^1]: Stange KC, Miller WL, Etz RS (2023). [The Role of Primary Care in Improving Population Health](https://doi.org/10.1111/1468-0009.12638){:target="_blank"}. Milbank Quarterly, 101:795-840.
[^2]: Think Global Health (accessed Oct 2025). [Diagnostic Gaps in Global Health](https://www.thinkglobalhealth.org/article/diagnostic-gaps-global-health){:target="_blank"}.
[^3]: World Health Assembly (accessed Oct 2025). [Strengthening diagnostics capacity](https://www.who.int/activities/strengthening-diagnostics-capacity){:target="_blank"}. [PDF](https://apps.who.int/gb/ebwha/pdf_files/WHA76/A76_R5-en.pdf).
[^4]: Africa CDC (accessed Oct 2025). [Africa Collaborative Initiative to Advance Diagnostics](https://africacdc.org/programme/laboratory-systems-and-networks/africa-collaborative-initiative-to-advance-diagnostics/){:target="_blank"}.
[^5]: Yimer SA, Booij BB, Tobert G, Hebbeler A, Oloo P, Brangel P, et al. (2024). [Rapid diagnostic test: a critical need for outbreak preparedness and response for high priority pathogens](https://doi.org/10.1136/bmjgh-2023-014386){:target="_blank"}. BMJ Global Health, 9:e014386.
[^6]: FIND and Unitaid (13-14 Apr 2023). [Building for sustainability: accelerating regional manufacturing for diagnostics](https://unitaid.org/publication/report-building-for-sustainability-accelerating-regional-manufacturing-for-diagnostics-find-and-unitaid/){:target="_blank"}. [PDF](https://www.finddx.org/wp-content/uploads/2024/01/20230413_rep_accelerating_rm_for_dx_FV_EN.pdf){:target="_blank"}.
[^7]: WHO (accessed 2025). [Incidence of tuberculosis (per 100 000 population per year)](https://data.who.int/indicators/i/13B4226/C288D13){:target="_blank"}.
[^8]: Brümmer LE, Thompson RR, Malhotra A, Shrestha S, Kendall EA, Andrews JR, Phillips P, Nahid P, Cattamanchi A, Marx FM, Denkinger CM, Dowdy DW (25 Jan 2024). [Cost-effectiveness of Low-complexity Screening Tests in Community-based Case-finding for Tuberculosis](https://doi.org/10.1093/cid/ciad501){:target="_blank"}. Clin Infect Dis. 78(1):154-163.
